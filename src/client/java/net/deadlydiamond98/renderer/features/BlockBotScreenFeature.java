...
public class BlockBotScreenFeature<T extends BaseBlockBotEntity> extends FeatureRenderer<T, BlockBotModel<T>> implements IBotScreenRenderer {

    protected static final float OFFSET = 0.0001f;
    
    public BlockBotScreenFeature(FeatureRendererContext<T, BlockBotModel<T>> context) {
        super(context);
    }
    ...
    private void renderScreen(T entity, VertexConsumerProvider vCon, MatrixStack matrices, int light) {
        ...
        matrices.translate(0, entity.eyePositionOffset(), 0);
        ...
        if (entity.showMouth(entity)) {
            ...
            matrices.translate(0, entity.getMouthOffset(), 0);

...
public class BlockBotModel<T extends BaseBlockBotEntity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-5.5F, -11.5F, -5.5F, 11.0F, 11.0F, 11.0F, new Dilation(0.0F))
				.uv(0, 22).cuboid(-5.5F, -11.5F, -5.5F, 11.0F, 11.0F, 11.0F, new Dilation(-0.25F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

...
public class BlockBotFollowOwnerGoal extends Goal {
    private final OwnedBlockBotEntity tameable;
    ...
    public BlockBotFollowOwnerGoal(OwnedBlockBotEntity tameable, double speed, float minDistance, float maxDistance, boolean leavesAllowed) {
    ...
    public boolean canStart() {
        ...
        if (livingEntity == null) {
            ...
            return this.tameable.followState == OwnedBlockBotEntity.BehaviorState.FOLLOWING;
        }
    }

...
public class BotBowAttackGoal<T extends BlockBotWithInventory & RangedAttackMob> extends Goal {
    ...
    public BotBowAttackGoal(T actor, double speed, int attackInterval, float range) {
        this.actor = actor;
        this.speed = speed;

...
//
//public class FaultyBlockBotEntityBackup extends HostileEntity implements IBlockBot<FaultyBlockBotEntityBackup> {
//
//    // Aesthetic Variables
//    private static final TrackedData<Integer> WIRE_COLOR = DataTracker.registerData(FaultyBlockBotEntityBackup.class, TrackedDataHandlerRegistry.INTEGER);
//    private static final TrackedData<Integer> WIRES = DataTracker.registerData(FaultyBlockBotEntityBackup.class, TrackedDataHandlerRegistry.INTEGER);
//
//    private static final TrackedData<Boolean> RUSTY = DataTracker.registerData(FaultyBlockBotEntityBackup.class, TrackedDataHandlerRegistry.BOOLEAN);
//    private static final TrackedData<Boolean> MOSSY = DataTracker.registerData(FaultyBlockBotEntityBackup.class, TrackedDataHandlerRegistry.BOOLEAN);
//
//    private static final TrackedData<Integer> SCREEN_BRIGHTNESS = DataTracker.registerData(FaultyBlockBotEntityBackup.class, TrackedDataHandlerRegistry.INTEGER);
//
//    private static final TrackedData<Integer> OUCHIE = DataTracker.registerData(FaultyBlockBotEntityBackup.class, TrackedDataHandlerRegistry.INTEGER);
//    private static final TrackedData<Boolean> TARGETING = DataTracker.registerData(FaultyBlockBotEntityBackup.class, TrackedDataHandlerRegistry.BOOLEAN);
//
//    public FaultyBlockBotEntityBackup(EntityType<? extends HostileEntity> entityType, World world) {
...
//        this.setScreenAlpha(this.getScreenAlpha(this) + 10);
//    }
//
//    @Nullable
//    @Override
...
//        this.dataTracker.startTracking(SCREEN_BRIGHTNESS, 25);
//    }
//
//    @Nullable
//    @Override
...
//        this.dataTracker.set(SCREEN_BRIGHTNESS, i);
//    }
//
//    @Override
//    public int getScreenAlpha(FaultyBlockBotEntityBackup entity) {
//        return IBlockBot.super.getScreenAlpha(entity);
//    }
//
//    @Override
//    public int getAge(FaultyBlockBotEntityBackup entity) {
//        return this.age;
//    }
//
//    @Override
//    public int getBlinkTimer(FaultyBlockBotEntityBackup entity) {
//        return 0;
//    }
//}
